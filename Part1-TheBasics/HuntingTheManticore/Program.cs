...
// Get a valid distance from user with NumberInRange method.
int stationDistance = NumberInRange();
...
// Get number only if it is in range 0 to 100, otherwise ask again.
int NumberInRange()
{
    while (true)
    {
